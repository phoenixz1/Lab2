...
FILES=Mazewar.class MazewarServerHandlerThread.class MazewarBroadcastThread.class MazewarPacket.class

all: ${FILES} MazewarServer.java MazewarPacket.java MazewarServerHandlerThread.java MazewarBroadcastThread.java
