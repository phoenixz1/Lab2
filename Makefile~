...
FILES=Mazewar.class MazewarServerHandlerThread.class MazewarBroadcastThread.class MazewarPacket.class MazewarServer.class MazewarTickerThread.class

all: ${FILES} MazewarServer.java MazewarPacket.java MazewarServerHandlerThread.java MazewarBroadcastThread.java MazewarTickerThread.java
