...
public class Mazewar extends JFrame {
        ...
        public static void quit() {
	        ...
	        //LocalClient.enquethread.interrupt();
		LocalClient.enquethread.terminate();
		...
		//try {
			...
			if((PackFromServ = (MazewarPacket) guiClient.inStream.readObject()) != null)
			{
			   ...
			   if(PackFromServ.type == MazewarPacket.MW_JOIN && !PackFromServ.cID.equals(guiClient.getName())){
			      System.out.println("recerived packet from client "+PackFromServ.cID );
		           ...
		           else if(PackFromServ.type == MazewarPacket.MW_START){
		              break;
		           }
		        }
			}*/
		...
		System.out.println("Creating overhead panel");
